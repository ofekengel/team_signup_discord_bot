...
class TeamsDBAPI:
    ...
    def insert_team(self, team_name: str, league: str = 'default') -> None:
        self.__api.execute_query(
            "insert into {} values ('{}', '{}')".format(self.__table_name, team_name, league))

    def get_team(self, team_name: str) -> Tuple:
        self.__api.execute_query("select * from {} where team_name = {}".format(self.__table_name, team_name))
